...
import {maxOfThree, sum, multiply, findLongestWord, generateArray, scoreExams , reverseArray, reverseArrayInPlace} from "../src/app.js";
...
// Describe block for the reverseArray and reverseArrayInPlace functions
describe("reverseArray", function () {
    it("tests reverseArray odd number elements", function () {
      assert.deepEqual(reverseArray(["A", "B", "C"]), ["C", "B", "A"]);
    });
  ...
  describe("reverseArrayInPlace", function () {
    it("tests reverse in place even number elements", function () {
      ...
      assert.deepEqual(array1, ["D", "C", "B", "A"]);
    });
    ...
    it("tests reverseinplace odd number elements", function () {
      ...
      assert.deepEqual(array2, [5, 4, 3, 2, 1]);
    });
  });
